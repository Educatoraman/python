...
class cotton_info:
    def __init__(self,root):
      self.root=root
      self.root.title("COTTON")
      self.root.geometry("1000x650+0+0")

      img1=Image.open(r"C:\Users\hp\Desktop\python\image\cottonin.jpg")
      ...
      img2=Image.open(r"C:\Users\hp\Desktop\python\image\cotton.jpg")
