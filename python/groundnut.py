...
class groundnut_info:
    def __init__(self,root):
      self.root=root
      self.root.title("GROUNDNUT")
      self.root.geometry("1000x650+0+0")

      img1=Image.open(r"C:\Users\hp\Desktop\python\image\groundi.jpg")
      ...
      img2=Image.open(r"C:\Users\hp\Desktop\python\image\groundnut.jpg")
